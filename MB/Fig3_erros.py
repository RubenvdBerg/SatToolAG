...
def fig3errorplot(path,inputR=False,inputM=False):
    ...
    create_fig3data(path,Isprange=(260,3600),step=20,inputR=inputR,inputM=inputM)
...
if __name__ == '__main__':
    fig3errorplot('Data/fig3datatest.csv',inputR=True,inputM=True)
