from openmdao.api import ExplicitComponent, Problem, ScipyOptimizeDriver, ExecComp, IndepVarComp
...
prob.model.connect('indeps.x', 'parab.x')
prob.model.connect('indeps.y', 'parab.y')
